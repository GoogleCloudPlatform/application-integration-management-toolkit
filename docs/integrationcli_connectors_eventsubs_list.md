## integrationcli connectors eventsubs list

List event subscriptions for a connection
...
```
integrationcli connectors eventsubs list [flags]
```

### Options

```
      --filter string      Filter condition for list
