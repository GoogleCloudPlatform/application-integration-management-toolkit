...
Set Connection Admin IAM policy on a Connection
...
```
  ...
  -p, --memberType string   memberType must be serviceAccount, user, or group (default serviceAccount) (default "serviceAccount")
```
