...
```
  ...
  -h, --help                      help for apply
      ...
      --tests-folder string       Path to a folder containing files for test case execution. File names MUST match display names. See ./samples/test-config.json for an example
