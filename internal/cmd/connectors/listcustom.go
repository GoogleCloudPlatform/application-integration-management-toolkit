...
// ListCustomCmd to get connection
var ListCustomCmd = &cobra.Command{
	Use:   "list",
	Short: "List all custom connections",
	Long:  "List all custom connections in a region",
...
func init() {
	...
	ListCustomCmd.Flags().IntVarP(&pageSize, "pageSize", "",
		-1, "The maximum number of versions to return")
	ListCustomCmd.Flags().StringVarP(&pageToken, "pageToken", "",
		"", "A page token, received from a previous call")
	ListCustomCmd.Flags().StringVarP(&filter, "filter", "",
		"", "Filter results")
}
